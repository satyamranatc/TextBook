    ...
    <div id = "App">
        ...
        <NavBar />  
          ...
          <Routes>
            ...
            <Route path='/courses/*' element = {<Course CourseData = {CourseData} setCourseData = {setCourseData} addCartCourses = {addCartCourses} setAddCartCourses = {setAddCartCourses} />} />
            <Route path='/practice' element = {<Practice CourseData = {CourseData} />} />
            <Route path='/doubt' element = {<Doubt/>} />
            <Route path='/contact' element = {<Contact/>} />
            <Route path='/cart' element = {<Cart addCartCourses = {addCartCourses}/>} />
            <Route path='/*' element = {
              <div>
